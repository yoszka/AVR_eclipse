/* biblioteka do sterowania wyœwietlacza alfanumerycznego LCD zgodnego ze sterownikiem HD44780
   Sterowanie w trybie 4-bitowym bez odczytu flagi zajêtoœci
   Mikrokontroler : Atmel ATmega
   Kompilator : avr-gcc
   Autor : Tomasz Jokiel
   Data : 30.07.2009
   Funkcje "LCD_ZapiszText" oraz "LCD_XY" na podstawie biblioteki Rados³awa Kwietnia: "HD44780.c"
*/
