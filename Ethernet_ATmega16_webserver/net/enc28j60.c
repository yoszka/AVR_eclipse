...
#define ENC28J60_CONTROL_SI     PORTB5      // MOSI
#define ENC28J60_CONTROL_SO     PORTB6      // MISO
#define ENC28J60_CONTROL_SCK    PORTB7      // SCK
// CS pin  - most atmega8 takes ANY pin, atmega168 will only work with PB2
// If not work then check if PB2 is mandatory
#define ENC28J60_CS_PORT        PORTB
#define ENC28J60_CS_DDR         DDRB
#define ENC28J60_CS_PIN         PORTB4      // /CS (/SS)
